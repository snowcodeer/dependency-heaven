  ...
  return (
    <div className="min-h-screen p-8 bg-gradient-to-br from-black to-slate-900 text-white max-w-7xl mx-auto">
      ...
      <div className="mb-6 text-center">
        <div className="inline-flex items-center gap-4 px-4 py-2 bg-gray-800/50 rounded-full border border-gray-700">
          <span className="text-xs text-gray-400">📦 Data cached for 5min</span>
          {analyzing && (
